  ...
  <div id="page">
    ...
    <div id="cabeca">
        ...
        <div id="base_titulo">
          ...
          <div id="titulo">
            <h1 style="color:#9C9D7E; font-family:'Times-New-Roman',Times,serif; text-align:center; font-size:80px;">LISTA DE CONTAS</h1>
          </div>
                  ...
                  <thead class="thead-sticky text-left">
                    <tr>
                      ...
                      <th id="td" v-for="col in columns" :key="col">
                        ...
                        <div v-else-if="col == 'descricao_conta'">
                  ...
                  <tr :key="index" >
                    ...
                    <td id="td" v-for="col in columns" :key="col">                     
                      ...
                      <div v-if="col == 'opcoes'">
                        ...
                        <q-btn id="botao_excluir" @click="excluir(linha)" color="red-10" icon="delete" push style="margin-left: 10px; margin-top: 10px;"/>
                      ...
                      <div v-else-if="col == 'baixado'">
                        ...
                        <div v-if="linha[col] == 'T'"> {{'PAGA'}} </div>
                        <div v-if="linha[col] == 'F'"> {{'PENDENTE'}} </div>
    ...
    <div id="cadastro">
        ...
        <div id="desc_val">
          ...
          <q-input class="input_manual" v-model="conta_nova.descricao_conta" label="Descrição:" stack-label :dense="dense"/>
        ...
        <div id="data_status">
          ...
          <div id="status">
            ...
            <q-toggle v-model="status_baixado" label="PAGA" style="width: 400px;" color="brand"/>                      
  ...
  export default{   
    ...
    methods: {
      ...
      cadastrar(){  
        ...
        if (this.status_baixado == true){
          this.conta_nova.baixado = 'T'
        }
        else if (this.status_baixado == false){ 
          this.conta_nova.baixado = 'F'
        }
      ...
      limparCampos(){
        ...
        this.conta_nova.descricao_conta = ''
        this.date = ''
        this.conta_nova.valor = this.valor
        this.status_baixado = false
      },
      ...
      projetar(conta){
        ...
        if(this.conta_nova.baixado == 'T'){

          this.status_baixado = true
        }
        else if(this.conta_nova.baixado == 'F'){
